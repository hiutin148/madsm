...
import 'package:madsm/features/authentication/ui/widgets/sign_in_agreement.dart';
...
class _WelcomeScreenState extends ConsumerState<WelcomeScreen> {
  ...
  void initState() {
    ...
    _authSubscription = supabase.auth.onAuthStateChange.listen((data) {
      ...
      debugPrint('${Constants.tag} [WelcomeScreen.initState] Auth change: $event, session: $session');
  ...
  Widget build(BuildContext context) {
    ref.listen(authenticationViewModelProvider, (previous, next) {
      ...
      if (next is AsyncData) {
        debugPrint('${Constants.tag} [WelcomeScreen.build] isRegisterSuccessfully = ${next.value?.isRegisterSuccessfully}, isSignInSuccessfully = ${next.value?.isSignInSuccessfully}');
          ...
          child: Column(
            ...
            children: [
              ...
              PrimaryButton(
                ...
                text: 'continue'.tr(),
                onPressed: () {
                  ref.read(authenticationViewModelProvider.notifier).signUpWithEmailAndPassword(
