...
import 'package:madsm/constants/languages.dart';
...
class AuthenticationViewModel extends _$AuthenticationViewModel {
  ...
  Future<void> signUpWithEmailAndPassword(String email, String password) async {
    state = const AsyncValue.loading();
    final authRepo = ref.read(authenticationRepositoryProvider);
    final result = await AsyncValue.guard(() => authRepo.signUpWithEmailAndPassword(email, password));
    ...
    if (result.value == null) {
      state = AsyncError(Languages.unexpectedErrorOccurred, StackTrace.current);
      return;
    }
  ...
  Future<void> signInWithEmailAndPassword(String email, String password) async {
    state = const AsyncValue.loading();
    final authRepo = ref.read(authenticationRepositoryProvider);
    final result = await AsyncValue.guard(() => authRepo.signInWithEmailAndPassword(email, password));
